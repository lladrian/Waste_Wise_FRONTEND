...
const MapLocationMarkerDraw = ({ 
  ...
  useEffect(() => {
    // Always update when routeData prop changes (for edit mode)
    ...
    // Update color when initialPolylineColor changes
  ...
  const center = initCenter || (routePoints.length > 0 ? routePoints[0] : selectedLocation);
