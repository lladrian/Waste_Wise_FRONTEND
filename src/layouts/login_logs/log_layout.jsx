...
import { getAllLoginLogSpecificUser, generateReportLoginLog, getAllLoginLog, generateReportLoginLogSpecificUser } from "../../hooks/log_management_hook";
...
const decryptData = (encryptedData, key) => {
    ...
    const downloadGeneratedReport = async () => {
        try {
            const res = await generateReportLoginLogSpecificUser(user?._id, {
